...
import {
	...
	type IUpdateJobHistorySchema,
} from "@/schemas/job-history/UpdateJobHistorySchema";
...
export default function UpdateJobHistoryModal({
	...
	const form = useForm<IUpdateJobHistorySchema>({
		resolver: zodResolver(UpdateJobHistorySchema),
		defaultValues: {
	...
	const { mutate: update, isPending } = useUpdateEmploymentHistory();
