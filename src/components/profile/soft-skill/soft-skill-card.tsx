...
export default function SoftSkillCard({ devSoftSkill, profileId, openDelete, openUpdate }: SoftSkillCardProps){

    return(
        <Card className="flex flex-col p-3 gap-3">
            <div className="flex flex-row justify-between items-center w-full">
            <span className="font-bold">
                {devSoftSkill.soft_skill.name}
            </span>
            ...
            <p className="text-foreground/80">{devSoftSkill.soft_skill_level_response.description}</p>
        </Card>
    );
}