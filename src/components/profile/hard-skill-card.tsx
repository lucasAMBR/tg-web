            ...
            <div className="flex items-center gap-2">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent side="bottom">
                        ...
                        <DropdownMenuGroup>
                            <DropdownMenuItem onClick={() => openUpdate(hardSkill)}><Edit /> Update</DropdownMenuItem>
                            <DropdownMenuItem onClick={() => openDelete(hardSkill)} variant="destructive"><Trash /> Delete</DropdownMenuItem>
                        </DropdownMenuGroup>
                    </DropdownMenuContent>
                </DropdownMenu>
            </div>
