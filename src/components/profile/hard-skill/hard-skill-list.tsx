...
export default function HardSkillList({ profileId }: HardSkillListPorps) {
	...
	const { data: hardSkill, isLoading } = useIndexHardSkill({
				...
				>
					<AlertDialogContent>
						<AlertDialogHeader>
							...
							<AlertDialogDescription>
								Delete a hard skill from your profile
							</AlertDialogDescription>
						</AlertDialogHeader>
						<p>
							Are you sure? This action is permanent and this hard skill will
							not be used anymore by out algorithm
						</p>
						<AlertDialogFooter>
